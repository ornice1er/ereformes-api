...
class ReformeController extends Controller
{
    ...
    public function show(Request $request, $id)
    {
        ...
        try {
            ...
            return Common::success('Réforme trouvé', $result);
        } catch (\Throwable $th) {
            $this->ls->trace(['action_name' => $message, 'description' => $th->getMessage()]);
    ...
    public function store(StoreReformeRequest $request)
    {
        ...
        try {
            ...
            return Common::successCreate('Réforme créé avec succès', $result);
        } catch (\Throwable $th) {
            $this->ls->trace(['action_name' => $message, 'description' => $th->getMessage()]);
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            return Common::successDelete('Réforme supprimé avec succès', $result);
        } catch (\Throwable $th) {
            $this->ls->trace(['action_name' => $message, 'description' => $th->getMessage()]);
    ...
    public function changeState($id, $state)
    {
        ...
        try {
            ...
            return Common::success("Réforme $statusMessage avec succès", $result);
        } catch (\Throwable $th) {
            $this->ls->trace(['action_name' => $message, 'description' => $th->getMessage()]);
